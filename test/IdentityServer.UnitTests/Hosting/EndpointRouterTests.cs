...
{
    private Dictionary<string, SMCT.IdentityServer.Hosting.Endpoint> _pathMap;
    private List<SMCT.IdentityServer.Hosting.Endpoint> _endpoints;
    private IdentityServerOptions _options;
    private EndpointRouter _subject;

    public EndpointRouterTests()
    {
        _pathMap = new Dictionary<string, SMCT.IdentityServer.Hosting.Endpoint>();
        _endpoints = new List<SMCT.IdentityServer.Hosting.Endpoint>();
    ...
    {
        Action a = () => new SMCT.IdentityServer.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
    ...
    {
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
    ...
    {
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
    ...
    {
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint(IdentityServerConstants.EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
        _endpoints.Add(new SMCT.IdentityServer.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
