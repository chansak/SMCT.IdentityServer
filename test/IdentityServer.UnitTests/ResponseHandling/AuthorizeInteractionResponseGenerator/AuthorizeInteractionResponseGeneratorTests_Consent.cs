...
{
    private SMCT.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
    ...
    {
        _subject = new SMCT.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator(
            _options,
            new StubClock(),
