...
public class CustomAuthorizeInteractionResponseGenerator : SMCT.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public CustomAuthorizeInteractionResponseGenerator(
        IdentityServerOptions options,
        IClock clock, 
        ILogger<SMCT.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator> logger, 
...
public class AuthorizeInteractionResponseGeneratorTests_Custom
{
    ...
    public AuthorizeInteractionResponseGeneratorTests_Custom()
    {
        _subject = new CustomAuthorizeInteractionResponseGenerator(
            _options,
            _clock,
            TestLogger.Create<SMCT.IdentityServer.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
            _mockConsentService,
