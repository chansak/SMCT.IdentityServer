...
using Xunit;
using Models = SMCT.IdentityServer.Models;
using Entities = SMCT.IdentityServer.EntityFramework.Entities;
...
public class ClientMappersTests
{
    ...
    {
        var entity = new SMCT.IdentityServer.EntityFramework.Entities.Client
        {
            Properties = new System.Collections.Generic.List<SMCT.IdentityServer.EntityFramework.Entities.ClientProperty>()
            {
                new SMCT.IdentityServer.EntityFramework.Entities.ClientProperty{Key = "foo1", Value = "bar1"},
                new SMCT.IdentityServer.EntityFramework.Entities.ClientProperty{Key = "foo1", Value = "bar2"},
            }
        };
