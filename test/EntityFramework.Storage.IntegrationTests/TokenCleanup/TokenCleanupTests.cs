...
using SMCT.IdentityServer.EntityFramework;
...
using SMCT.IdentityServer.EntityFramework.Stores;
...
using Xunit;
using IPersistedGrantStore = SMCT.IdentityServer.Stores.IPersistedGrantStore;
...
public class TokenCleanupTests : IntegrationTest<TokenCleanupTests, PersistedGrantDbContext, OperationalStoreOptions>
{
    ...
    private TokenCleanupService CreateSut(DbContextOptions<PersistedGrantDbContext> options)
    {
        ...
        services.AddIdentityServer()
            ...
            .AddInMemoryClients(new List<SMCT.IdentityServer.Models.Client>())
            .AddInMemoryIdentityResources(new List<SMCT.IdentityServer.Models.IdentityResource>())
            .AddInMemoryApiResources(new List<SMCT.IdentityServer.Models.ApiResource>());
