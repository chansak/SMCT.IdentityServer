...
public class Index : PageModel
{
    ...
    private ViewModel CreateConsentViewModel(DeviceFlowAuthorizationRequest request)
    {
        ...
        {
            apiScopes.Add(GetOfflineAccessScope(Input == null || Input.ScopesConsented.Contains(SMCT.IdentityServer.IdentityServerConstants.StandardScopes.OfflineAccess)));
        }
