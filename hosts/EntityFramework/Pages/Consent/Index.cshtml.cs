...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        else if (Input.Button == "yes")
        {
            ...
            if (Input.ScopesConsented.Any())
            {
                ...
                {
                    scopes = scopes.Where(x => x != SMCT.IdentityServer.IdentityServerConstants.StandardScopes.OfflineAccess);
                }
    ...
    private ViewModel CreateConsentViewModel(AuthorizationRequest request)
    {
        ...
        {
            apiScopes.Add(CreateOfflineAccessScope(Input == null || Input.ScopesConsented.Contains(SMCT.IdentityServer.IdentityServerConstants.StandardScopes.OfflineAccess)));
        }
    ...
    private static ScopeViewModel CreateOfflineAccessScope(bool check)
    {
        return new ScopeViewModel
        {
            Value = SMCT.IdentityServer.IdentityServerConstants.StandardScopes.OfflineAccess,
