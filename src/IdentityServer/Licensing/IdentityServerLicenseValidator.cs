...
internal class IdentityServerLicenseValidator : LicenseValidator<IdentityServerLicense>
{
    ...
    public void ValidateClient(string clientId)
    {
        ...
        if (License != null)
        {
            ...
            {
                ErrorLog.Invoke(
                    "Your license for SMCT IdentityServer only permits {clientLimit} number of clients. You have processed requests for {clientCount}. The clients used were: {clients}.",
    ...
    public void ValidateServerSideSessions()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("You have configured server-side sessions. Your license for SMCT IdentityServer does not include that feature. This feature requires the Business or Enterprise Edition tier of license.");
            }
        }
    ...
    public void ValidateDPoP()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A request was made using DPoP. Your license for SMCT IdentityServer does not include the DPoP feature. This feature requires the Enterprise Edition tier of license.");
            }
        }
    ...
    public void ValidateResourceIndicators(string resourceIndicator)
    {
        if (!String.IsNullOrWhiteSpace(resourceIndicator))
        {
            if (License != null)
            {
                ...
                {
                    throw new Exception("A request was made using a resource indicator. Your license for SMCT IdentityServer does not permit resource isolation. This feature requires the Enterprise Edition tier of license.");
                }
            }
    ...
    public void ValidatePar()
    {
        if(License != null)
        {
            ...
            {
                throw new Exception("A request was made to the pushed authorization endpoint. Your license of SMCT IdentityServer does not permit pushed authorization. This features requires the Business Edition or higher tier of license.");
            }
        }
    ...
    public void ValidateDynamicProviders()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A request was made invoking a dynamic provider. Your license for SMCT IdentityServer does not permit dynamic providers. This feature requires the Enterprise Edition tier of license.");
            }
        }
    ...
    public void ValidateCiba()
    {
        if (License != null)
        {
            ...
            {
                throw new Exception("A CIBA (client initiated backchannel authentication) request was made. Your license for SMCT IdentityServer does not permit the CIBA feature. This feature requires the Enterprise Edition tier of license.");
            }
        }
