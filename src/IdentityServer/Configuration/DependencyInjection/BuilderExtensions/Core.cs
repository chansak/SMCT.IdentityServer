...
using SMCT.IdentityServer.Configuration.DependencyInjection;
using SMCT.IdentityServer.Endpoints;
...
using static SMCT.IdentityServer.IdentityServerConstants;
using SMCT.IdentityServer.Extensions;
using SMCT.IdentityServer.Hosting.FederatedSignOut;
using SMCT.IdentityServer.Services.Default;
using SMCT.IdentityServer.Services.KeyManagement;
using Microsoft.Extensions.Logging;
using SMCT.IdentityServer.Hosting.DynamicProviders;
using SMCT.IdentityServer.Internal;
using SMCT.IdentityServer.Stores.Empty;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where TEndpoint : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new SMCT.IdentityServer.Hosting.Endpoint(name, path, typeof(TEndpoint)));
