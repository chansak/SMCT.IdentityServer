...
public static class IdentityServerConstants
{
    ...
    {
        public static readonly string Basic = SMCT.IdentityServer.Tracing.TraceNames.Basic;
        public static readonly string Stores = SMCT.IdentityServer.Tracing.TraceNames.Store;
        public static readonly string Cache = SMCT.IdentityServer.Tracing.TraceNames.Cache;
        public static readonly string Validation = SMCT.IdentityServer.Tracing.TraceNames.Validation;
        public static readonly string Services = SMCT.IdentityServer.Tracing.TraceNames.Services;

        public static readonly string ServiceVersion = SMCT.IdentityServer.Tracing.ServiceVersion;
    }
