...
public class PersistedGrantStore : SMCT.IdentityServer.Stores.IPersistedGrantStore
{
    /// <summary>
    /// The DbContext.
    /// </summary>
    ...
    /// <inheritdoc/>
    public virtual async Task StoreAsync(SMCT.IdentityServer.Models.PersistedGrant token)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<SMCT.IdentityServer.Models.PersistedGrant> GetAsync(string key)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IEnumerable<SMCT.IdentityServer.Models.PersistedGrant>> GetAllAsync(PersistedGrantFilter filter)
    {
