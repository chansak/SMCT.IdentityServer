...
internal class ConfigurationLicenseValidator : LicenseValidator<ConfigurationLicense>
{
    ...
    protected override void ValidateProductFeatures(List<string> errors)
    {
        ...
        {
            throw new Exception($"You are using the IdentityServer Configuration API feature. Your license for SMCT IdentityServer does not include that feature. This feature requires the Business or Enterprise Edition tier of license.");
        }
    }
